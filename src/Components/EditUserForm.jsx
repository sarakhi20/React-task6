  ...
  return (
    <>
      <div className="container">
        <div className="row">
          <form onSubmit={handleUpdate} className="bg-info my-3 py-3 px-5">
            ...
            <div className="row">
              ...
              <div className="col-12 text-center">
                <button type="submit" className="btn btn-dark w-50 mx-2">
                  Update User
                </button>
              </div>
            </div>
